# Generated by Powerlevel10k configuration wizard on 2022-09-19 at 20:01 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # custom segment functions at line 1573
    uname
    divider
    hostname
    dir                     
  ...
  function prompt_hostname() {
    p10k segment -f 008 -t $(cat /etc/hostname)
  }
